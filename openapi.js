var IS_CLIENT_SIDE = "undefined" != typeof window, IS_ANDROID_WEBVIEW = Boolean(IS_CLIENT_SIDE && window.AndroidBridge),
...
if (function (e) {
    if (!e.fastXDM) {
        var t = {}, o = {}, i = [], n = {};
        e.fastXDM = {
            _id: 0, helperUrl: "https://vk.com/js/api/xdmHelper.js", Server: function (o, i, n) {
            ...
            for (var t = Array.prototype.slice.call(arguments), o = t.shift(), i = 0, n = t.length; i < n; i++) if ("function" == typeof t[i]) {
                ...
                var s = t[i], l = "_func" + this.funcsCount;
            ...
            r(this, "caller", (function () {
                e.fastXDM.on(this.id, (function () {
                    d((function (i) {
                        var n = this, r = e.fastXDM.getProxyToServer(this.key, o);
        ...
        }, e.JSON && "object" == typeof e.JSON && e.JSON.parse && e.JSON.stringify && '{"a":[1,2,3]}' === e.JSON.stringify({a: [1, 2, 3]}).replace(/ /g, "") ? n.json = {
            parse: e.JSON.parse,
    ...
    return function (e) {
        ...
        var i, d, l, p, u = 1732584193, c = -271733879, h = -1732584194, f = 271733878;
    ...
    VK.extend(VK, {
        ...
        _nameTransportPath: "",
        xdReady: !1,
        access: {FRIENDS: 2, PHOTOS: 4, AUDIO: 8, VIDEO: 16, MATCHES: 32, QUESTIONS: 64, WIKI: 128}
    }), VK.init = function (e) {
        var t, o;
        ...
        _headId: null, _callbacks: {}, ie6_7: function () {
        ...
        popup: null, lsCb: {}, setSession: function (e, t, o, i) {
            var n = !VK._session && e, r = VK._session && !e, s = VK._session && e && VK._session.mid != e.mid,
                a = n || r || VK._session && e && VK._session.sid != e.sid, d = t != VK._userStatus,
        ...
        _appOpened: !1, _addToGroupPopup: null, open: function (e, t) {
...
VK.UI || (VK.UI = {
    active: null, _buttons: [], popup: function (e) {
        var t, o = void 0 !== window.screenX ? window.screenX : window.screenLeft,
            ...
            r = void 0 !== window.outerHeight ? window.outerHeight : document.body.clientHeight - 22, s = e.width,
            a = e.height, d = parseInt(o + (n - s) / 2, 10), l = parseInt(i + (r - a) / 2.5, 10);
    ...
    _subscribers: function () {
        ...
        var t, o, i = Array.prototype.slice.call(arguments), n = (e = i.shift(), this._subscribers()[e]);
    ...
    }, {startHeight: 133, minWidth: 300}, (function (e, t, o) {
        n = o
    }))
    ...
    }, {startHeight: 90, minWidth: 250}, (function (e, t, o) {
        r = o
    }))
    ...
    return n = VK.Util.parseOptions(n), VK.Widgets._constructor("widget_textlive.php", e, n, {
        ...
        textpost_id: o,
        hash: i || ""
    }, null, {startHeight: o ? 176 : 167, minWidth: 320})
    ...
    return e = function (e, o, i) {
        ...
        if (!VK._apiId) throw Error("VK not initialized. Please use VK.init");
        var r, s, a, d, l, p, u = {18: 43, 20: 47, 22: 51, 24: 55, 30: 67},
            c = "full" == (o = VK.extend(VK.Util.parseOptions(o), {allowTransparency: !0})).type || "button" == o.type || "vertical" == o.type || "mini" == o.type ? o.type : "full",
            h = "auto" === o.width && ("button" == c || "mini" == c), f = parseInt(o.height, 10) || 22,
            g = f && u[f] ? f : 22,
            m = h ? 153 : "full" == c ? Math.max(200, o.width || 350) : "button" == c ? 180 : "mini" == c ? 115 : u[g],
            _ = "vertical" == c ? 2 * f + 7 : f, y = {
                page: i || 0,
                url: o.pageUrl || n.url,
                type: c,
                verb: 1 == o.verb ? 1 : 0,
        ...
        function V(e) {
            if ((b || e) && l && d && l && ("none" == d.style.display || "yes" == d.getAttribute("vkhidden"))) {
                ...
                var t = o.getScrollTop ? o.getScrollTop() : document.body.scrollTop || document.documentElement.scrollTop || 0,
                    i = VK.Util.getXY(r, o.fixed), n = v ? 0 : i[1];
        ...
        var x = VK.Widgets._constructor("widget_like.php", e, o, y, {
            initTooltip: function (e) {
                l = new fastXDM.Server({
                    ...
                    }, proxy: a, showBox: function (e, t) {
                        VK.Util.Box(VK.Util.getAbsUrl(e), [t.width, t.height], {proxy: l}).show()
                    }
                }, !1, {safe: !0}), (d = l.append(v ? r : document.body, {
        ...
        }, {startHeight: _, minWidth: m}, (function (e, t, o) {
            a = o, VK.Util.ss(r = e, {
                height: _ + "px",
                width: m + "px",
                position: "relative",
    ...
    }, {startHeight: 144, minWidth: 300}, (function (e, t, o) {
        n = o
    }))
    ...
    return i = o.width, VK.Widgets._constructor("widget_app.php", e, o, s, {}, {startHeight: n, height: r, minWidth: i})
    ...
    var i, n, r = {gid: o, mode: t.mode ? t.mode : "0"},
    ...
    }, {minWidth: 120, startHeight: s}, (function (e, t, o) {
        i = o
    }))
    ...
    }, {minWidth: 220, startHeight: 22}, (function (e, t, o) {
        i = o
    }))
    ...
    var i = {
        oid: o,
        height: {18: 18, 20: 20, 22: 22, 24: 24, 30: 30}[parseInt(t.height, 10) || 24],
    ...
    t = VK.Util.parseOptions(t);
    var o = {
        height: {18: 18, 20: 20, 22: 22, 24: 24, 30: 30}[parseInt(t.height, 10) || 30],
    ...
    }, {minWidth: 200}, (function (e, t, o) {
        r = o
    }))
}, VK.Widgets.Ads = function (e, t, o) {
    t = VK.Util.parseOptions(t), o = o || {};
    var i, n = {}, r = {}, s = {}, a = document.getElementById(e), d = {}, l = {}, p = {};
    for (var u in o) {
    ...
    if (e) return e;
    var t = {}, o = {},
        i = {no_button: {width: 0, height: 0}, blue_circle: {width: 50, height: 50, margin: {bottom: 20}}},
    ...
    return e = function (r, s, a) {
        ...
        function b() {
            var e = document.getElementById(r), t = e.getElementsByTagName("iframe")[0];
            e.style.width = t.width = "372px", e.style.height = t.height = "399px", e.style.margin = "0px 0px 0px 0px"
        }

        function w() {
            var e = document.getElementById(r), t = e.getElementsByTagName("iframe")[0], o = i[l], n = o.width + g[0],
        ...
        function I(e) {
            ...
            t && t.contentWindow.postMessage({handler: "VKReforgedWidgetExpand"}, VK._domain.base), clearTimeout(_.showTimer), x("expand", e)
        }
        ...
        return t[r] = VK.Widgets._constructor("reforged_widget.php", r, a, d, {
            onStartLoading: function () {
                ...
                (h = VK.Util.Box(VK.Util.getAbsUrl(e), [], {proxy: u}, {zIndex: 10002})).show()
            ...
            minimize: function () {
                ...
                e && e.contentWindow.postMessage({handler: "VKReforgedWidgetMinimize"}, VK._domain.base)
            },
            destroy: function () {
                v();
                var t = document.getElementById(r).getElementsByTagName("iframe")[0];
                t && t.contentWindow.postMessage({handler: "VKReforgedWidgetDestroy"}, VK._domain.base), e.destroy(r)
            },
            setSourceData: C,
    ...
    getPageData: function () {
        if (!VK._pData) {
            var e, t = document.getElementsByTagName("meta"), o = {},
        ...
        VK.Util.Loader(!0);
        var r = /(^|\.)(vk\.com|vkontakte\.ru)$/.test(location.hostname), s = new fastXDM.Server(VK.extend(o, {
            onInit: function () {
        ...
        }, !0), !1, {safe: !0}), a = s.append(document.body, {
            src: e.replace(/&amp;/g, "&"),
            scrolling: "no",
            allowTransparency: !0,
            style: {
    ...
    pixelCode: null, Init: function (e) {
        ...
        if (this.pixelCode && t && e) {
            ...
            var s = VK.Util.getPageData(), a = s.url.substr(0, 500), d = s.title && s.title.substr(0, 500) || "",
                l = VK._domain.base + "/rtrg", p = o ? JSON.stringify(o) : "", u = {
                    p: this.pixelCode,
                    products_event: t,
                    price_list_id: e,
                    e: "1",
    ...
    if (i && "string" == typeof i) {
        ...
        if ("string" == typeof n) {
            ...
            if (IS_BRIDGE_AVAILABLE) _bridgeSend("VKWebAppConversionHit", {
                ...
                var s = VK._domain.base + "/rtrg", a = {p: i, e: "1", c: n, v: r},
